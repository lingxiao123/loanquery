...
<body onload="yzm();" style="background-color:#1c77ac; background-image:url(<%=path %>/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
    ...
    <ul>
    <li><input name="user.user_name" id="username" type="text" class="loginuser" value="" onclick="JavaScript:this.value=''"/></li>
    <li><input name="user.user_passWord" id="userpwd"  type="password" class="loginpwd" value="" onclick="JavaScript:this.value=''"/></li>
    <li class="yzm">
    <span><input name="" id="sryzm" type="text" value="验证码" onclick="JavaScript:this.value=''"/></span><cite id="yzm"></cite> 
    </li>
    <li><input name="" type="submit" class="loginbtn" value="登录"  onclick="login();"  /><label><input  id="remember" name="remember"  type="checkbox" value="" />记住登录名</label><label></label></li>
    </ul>
    </div>   
    </div>
